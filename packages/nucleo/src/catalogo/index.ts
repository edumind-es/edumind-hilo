...
export const INSTRUMENTOS: Instrumento[] = [
  {
    ...
    anio: '2026',
    referencia: 'Moreno, J. L. (1934). Who shall survive? Nervous and Mental Disease Publishing. Arruga i Valeri, A. (1983). Introducción al test sociométrico. Herder.',
  ...
  },
  {
    ...
    autores: 'Moreno, J. L.',
    anio: '1934',
    referencia: 'Moreno, J. L. (1934). Who shall survive? A new approach to the problem of human interrelations. Nervous and Mental Disease Publishing.',
  ...
  },
  {
    ...
    anio: '1982',
    referencia: 'Coie, J. D., Dodge, K. A. y Coppotelli, H. (1982). Dimensions and types of social status: A cross-age perspective. Developmental Psychology, 18(4), 557-570.',
  ...
  },
  {
    ...
    anio: '1983 · 1990',
    referencia: 'Arruga i Valeri, A. (1983). Introducción al test sociométrico. Herder. González Álvarez, J. (1990). Sociometría por ordenador. Generalitat Valenciana.',
  ...
  },
  {
    ...
    anio: '1996 · 2009',
    referencia: 'Bukowski, W. M., Newcomb, A. F. y Hartup, W. W. (Eds.) (1996). The company they keep: Friendship in childhood and adolescence. Cambridge University Press. Cillessen, A. H. N. (2009). Sociometric methods. En K. H. Rubin, W. M. Bukowski y B. Laursen (Eds.), Handbook of peer interactions, relationships, and groups (pp. 82-99). Guilford.',
  ...
  },
  {
    ...
    autores: 'Cerezo, F.',
    anio: '2000',
    referencia: 'Cerezo, F. (2000). Bull-S. Test de evaluación de la agresividad entre escolares. Albor-Cohs.',
  ...
  },
  {
    ...
    autores: 'Johnson, D. W. y Johnson, R. T. (marco); adaptación EDUmind',
    anio: '1999',
